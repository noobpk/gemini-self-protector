...
class _Protect(object):
    ...
    def __handle_abnormal_response__(_request, _request_header, _request_body, _response, _response_header, _response_content, _score, _attack_type, _ticket) -> None:
        try:
