...
<head>
    ...
    <meta name="viewport"
        content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no" />
    <meta name=owned content="lethanhphuc(noobpk)">
    <title>Gemini-self-protector update license key</title>
    <style>
        html,
        body,
        #root {
...
<body>
    <div class="center-container">
        <div class="card-box">
            <div class="header">
                <h1 class="main">Update your Gemini-Self-Protector license key</h1>
                <div class="sub">
                    <a href="https://github.com/noobpk/gemini-self-protector" target="_blank">Need a license key?</a>
                </div>
            </div>
            <div class="content">
                <form class="login-form" method="post">
                    <div class="field">
                        <input required autofocus class="password" type="text" placeholder="KEY" name="key" />
                        <input class="submit -button" value="SUBMIT" type="submit" />
                    </div>
                </form>
            </div>
...
class _Template(object):
    ...
    def gemini_template(flask_template_folder):
        ...
        try:
            ...
            with open(flask_template_folder+'/gemini_protector_template/license.html', 'w+', encoding="utf-8") as f:
                f.write(template_license)
